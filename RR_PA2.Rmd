...
The analysis revealed that tornadoes are the most impactful weather event with respect to population health, accounting for 62.30% of casualties (injuries + fatalities), followed distantly by thunderstom winds, excessive heat, flood, lightning, heat and flash flood.
...
When it comes to economic losses, the most impactful weather event is flood, which accounts for about 33.75% of total losses (property + crop damage), followed somewhat closely by hurricanes, tornadoes, storm tides, hail, flash flood and drought.
